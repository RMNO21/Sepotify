...
fun DownloadsScreen(navController: NavController) {
    ...
    val batchDownloads by com.music.spotui.di.SongPlayer.batchDownloads.collectAsState()
    val activeBatches = batchDownloads.values.filter { it.isDownloading }
    ...
    Surface(
        ...
        Scaffold(
            ...
            Column(
                ...
                // ── Active Playlist Downloads (Batch progress) ──
                                ...
                                Column(modifier = Modifier.padding(14.dp)) {
                                    Row(
                                        ...
                                        Column(modifier = Modifier.weight(1f)) {
                                            ...
                                            Text(
                                                text = "${batch.completedTracks} of ${batch.totalTracks} downloaded • ${batch.progressPercent}%" +
                                                        if (batch.failedTracks > 0) " (${batch.failedTracks} skipped)" else "",
                                                color = accent,
                                                fontSize = 12.sp,
                                                fontWeight = FontWeight.Medium
                                            )
                                        ...
                                        Icon(
                                            ...
                                            modifier = Modifier
                                                .size(22.dp)
                                                .clickable {
                                                    com.music.spotui.di.SongPlayer.cancelBatchDownload(batch.playlistId)
                                                }
                                        )
                                    }
                                    if (batch.currentTrackTitle.isNotBlank()) {
                                        ...
                                        Row(verticalAlignment = Alignment.CenterVertically) {
                                            ...
                                            Text(
                                                text = "Current: ${batch.currentTrackTitle}",
                                    ...
                                    androidx.compose.material3.LinearProgressIndicator(
                                        progress = { (batch.progressPercent.coerceIn(0, 100)) / 100f },
                                        modifier = Modifier
                                            .fillMaxWidth()
                                            .height(5.dp)
